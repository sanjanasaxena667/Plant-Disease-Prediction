...
⚠️ Note: The dataset and model files are not included in this repository due to their large size. Instructions to set them up are provided below.

⭐ Key Features

✔️ Complete image classification pipeline in a single notebook
✔️ CNN / Transfer Learning-based architecture (depending on notebook choice)
✔️ GPU-accelerated training support
✔️ Data preprocessing + augmentation built-in
✔️ Evaluation metrics, accuracy curves, and confusion matrix
✔️ Ready for deployment or further model experimentation
